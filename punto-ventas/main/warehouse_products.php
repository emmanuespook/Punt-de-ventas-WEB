...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Productos de <?php echo $warehouse; ?>
			</div>
			<ul class="breadcrumb">
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Volver</button></a>
			...
			include('../connect.php');
				...
				$result = $db->prepare("SELECT * FROM products WHERE warehouse='$warehouse' ORDER BY qty_sold DESC");
				$result->execute();
			...
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM products where warehouse='$warehouse' and qty < 2 ORDER BY product_id DESC");
				$result->execute();
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				include('../connect.php');
				$result = $db->prepare("SELECT *, price * qty as total FROM products WHERE warehouse='$warehouse' ORDER BY product_code ASC");
				$result->execute();
