...
<span>Modelo : </span><input type="text" style="width:265px; height:30px;" name="gen" Required/><br>

<span>Descripcion : </span><textarea style="width:265px; height:50px;" name="name"> </textarea><br>
...
<option></option>
	...
	include('../connect.php');
		...
		$result->bindParam(':userid', $res);
		$result->execute();
		for($j=0; $raw = $result->fetch(); $j++){
	?>
		<option><?php echo $raw['warehouse_nickname']; ?></option>
	<?php
	}
	?>
</select><br>
